...
import portraitImage from '@/images/avery.png'
...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Avery Hill</title>
        <meta
          name="description"
          content="I’m Avery Hill. I live in Playa Vista where I design the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m Avery Hill. I live in Playa Vista where I design the future.
            </h1>
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink
                href="mailto:avery@stacksjs.dev"
                icon={MailIcon}
                className="mt-4"
              >
                avery@stacksjs.dev
