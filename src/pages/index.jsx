...
import logoPs1 from '@/images/logos/ps1.png'
import logoCion from '@/images/logos/cion.png'
import logoChf from '@/images/logos/chf.png'
...
function Resume() {
  let resume = [
    {
      company: 'Chris Howell Foundation',
    ...
    {
      company: 'PS1 Pluralistic School',
      title: 'Business & Advancement Office',
      logo: logoPs1,
      start: '2018',
      end: {
        label: '2022',
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Avery Hill - Dog lover, event planner, founder and entrepreneur based in Silicon Beach.
        </title>
        <meta
          name="description"
          content="I’m Avery, a event planner and entrepreneur based in Playa Vista, CA—also known as Silicon Beach. I’m the founder of Stacks.js, Meema and CION."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Event planner, community builder, and dog lover 🐶
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Avery, an event planner and community builder based in Playa Vista, CA. I’m Avery, an event planner and community builder based in Playa Vista, CA.
          </p>
